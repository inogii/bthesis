...
class GAT(nn.Module):
    def __init__(self, in_feats, h_feats, num_heads=1):
        ...
        self.conv3 = GATConv(h_feats, h_feats, num_heads)
        self.conv4 = GATConv(h_feats, h_feats, num_heads)
    ...
    def forward(self, g, in_feat):
        ...
        h = F.relu(h)
        h = self.conv4(g, h)
        h = torch.flatten(h, start_dim=1, end_dim=5)
        return h
...
class GIN(nn.Module):
    def __init__(self, in_feats, h_feats):
        ...
        self.conv3 = GINConv(self.linear3)
