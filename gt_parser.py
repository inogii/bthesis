...
if __name__ == "__main__":
    ...
    node_parameters = {
        # TODO check encoding of each parameter
        ...
        # link properties
        'link_vp_visibility': {'encoding': relationship_encoding, 'is_y': False},
    ...
    data = {'node' : nodes['node'], 'link': links['link']}
